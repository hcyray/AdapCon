 ...
 */
#ifndef SERVER_TRAFFIC_HELPER_H
#define SERVER_TRAFFIC_HELPER_H
 ...
 */
class ServerTrafficHelper
{
public:
  /**
   * Create ServerTrafficHelper which will make life easier for people trying
   * to set up simulations with Communicates.
   *
   * \param port The port the server will wait on for incoming packets
   */
  ServerTrafficHelper (uint16_t nodeid, uint16_t port);
  /**
