...
#ifndef UDP_Communicate_CLIENT_H
#define UDP_Communicate_CLIENT_H
 ...
 * \brief A Udp communicate client
 *
 * Every packet sent should be returned by the server and received here.
 */
class UdpCommunicateClient : public Application 
{
public:
  /**
  ...
  UdpCommunicateClient ();

  virtual ~UdpCommunicateClient ();
   ...
   * care) by this call.
   *
   * \warning If you have set the fill data for the communicate client using one of the
   * SetFill calls, this will undo those effects.
   *
   * \param dataSize The size of the communicate data you want to sent.
   */
   ...
   * \param dataSize The desired size of the resulting communicate packet data.
   */
   ...
   * \param dataSize The desired size of the final communicate data.
   */
...
#endif /* UDP_Communicate_CLIENT_H */
