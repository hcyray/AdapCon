 ...
 */
#include "udp-communicate-helper.h"
#include "ns3/udp-communicate-server.h"
#include "ns3/udp-communicate-client.h"
#include "ns3/uinteger.h"
#include "ns3/names.h"

namespace ns3 {

UdpCommunicateServerHelper::UdpCommunicateServerHelper (uint16_t port)
{
