 ...
 */
#ifndef USER_TRAFFIC_HELPER_H
#define USER_TRAFFIC_HELPER_H
 ...
 */
class UserTrafficHelper
{
public:
  /**
   * Create UserTrafficHelper which will make life easier for people trying
   * to set up simulations with Communicates.
   *
   * \param port The port the server will wait on for incoming packets
   */
  UserTrafficHelper (Address address, uint16_t port);
  /**
